"""EmbeddingService — from application/services/embedding_service.py."""
...
from app.models.entities import Chunk, EmbeddingJob
from app.models.enums import EmbeddingStatus
from app.repositories.document_store import PgChunkRepository, PgEmbeddingJobRepository
from app.repositories.vector_store import EmbeddingProvider
        ...
        async with self._session_factory() as session:
            ...
            async def _safe_batch(
                ...
                try:
                    ...
                    return [
                        (c.id, v) for c, v in zip(batch_chunks, vectors, strict=True)
                    ], 0
                except Exception as exc:
